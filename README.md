...
| **Media and documents** | Rockbox Music with card-root browsing, a Winamp-style VFD skin and FFT visualizer; both the SwitchFrogUI Videos player and a separate exact TreeFrogUI v1.2.0_b TreeVidPlay hardware player; SRT/WebVTT subtitles and timing offsets in Videos; an internal Photo viewer with folder navigation, rotate, 12× zoom and pan; Ebooks; public-domain samples; whole-card Files with remembered folder cursors, automatic handlers plus a dimmed popup, multi-select, and confirmed recursive copy/cut/paste/delete, rename, and folder creation. |
...
| **New applications** | Rockbox Music integration; H.OS hardware Videos plus the separate upstream TreeVidPlay option; internal Photo viewer; whole-card Files; Terminal; Text Editor; JSDev; permanent Ebooks card and sample material. |
