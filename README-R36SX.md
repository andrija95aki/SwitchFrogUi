...
| --- | --- |
| **Stock H.OS 1.2** | Switch-style Home and category-tabbed game library, broad emulator/core collection, save and resume tools, Rockbox, hardware video with subtitles, Ebooks, confirmed recursive file management, Terminal, Text Editor, JSDev, themes/fonts/sounds, keyboard mapping, diagnostics, and R36SX display/power/volume fixes. |
