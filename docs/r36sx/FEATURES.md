...
- Text entry keeps the controller-operated virtual keyboard hidden initially.
  It covers game search, page entry, file and
  folder naming, Text Editor prompts and editing, and Terminal commands.
  Select shows or hides it on demand; L1 switches letters/symbols, R1 changes
